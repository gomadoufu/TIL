...
より高機能な配列を使用したいときは、std::arrayを使う
...
連想配列とか辞書とか名前がいっぱいあるね
std::mapを使う。std::unorderd_mapの方がハッシュ法使ってて速いけど。
...
これもstd::setとstd::unordered_setがある
```C++
#include <set>
